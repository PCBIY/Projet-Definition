...
V3 — Fully Integrated Workflow
	•	Automated soldermask deposition
	•	Automated curing
...
🧪 Current Status
	•	Mechanical concept being defined
	•	Toolpath strategies under development
	•	Via riveting process being tested
	•	Firmware architecture planning phase
...
To be determined (MIT? CERN OHL? GPL?).
